...
Breaking assumptions. Hunting vulnerabilities. Building tools.

Security Researcher and Penetration Tester based in Goa, India.
...
Sentinel
Threat monitoring and security intelligence platform.

SocMint-X
Manual-first OSINT framework for deep investigations.

IntelScout (Private)
Threat intelligence and reconnaissance platform.

FrontierWatch
OSINT & GEOINT monitoring system.
...
- Web, API, and network security assessments
- Manual vulnerability discovery
- Custom security tooling
- Security testing for private clients
